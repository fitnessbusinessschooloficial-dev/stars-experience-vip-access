import { Check, Dumbbell, Building2, User, Users2, TrendingUp, BarChart } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="space-y-8">
            <div className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <h3 className="text-2xl font-bold mb-6 text-center">O Stars Experience é feito para:</h3>
              <div className="grid md:grid-cols-2 gap-4">
                {profiles.map((profile, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-4 bg-card p-6 rounded-xl border border-border hover:border-primary/50 transition-smooth hover:shadow-glow group"
                  >
                    ...
                    <p className="text-foreground font-medium">{profile.text}</p>
                  </div>
                ))}
              </div>
            </div>

            <div className="bg-gradient-section rounded-2xl p-8 lg:p-12 shadow-card animate-slide-up" style={{ animationDelay: '0.4s' }}>
              <h3 className="text-2xl font-bold mb-8 text-center">Ideal para quem deseja:</h3>
              <div className="grid md:grid-cols-2 gap-4">
